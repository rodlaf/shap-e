# https://github.com/ynyBonfennil/OBJwVC_to_glTF/blob/main/OBJwVC_to_glTF.py
...
if __name__ == "__main__":
    ...
    if EXPORT_AS_GLB:
        ...
        gltf.buffers[0].uri = "data:application/octet-stream;base64," + base64.b64encode(indices_chunk + vertices_chunk + vcolor_chunk + vnorm_chunk).decode()
